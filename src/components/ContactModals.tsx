...
export const ContactSupplierModal: React.FC<ContactSupplierModalProps> = ({ isOpen, onClose, supplierName }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call our GHL-integrated contact-vendor API
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <select name="subject" className="w-full p-3 bg-bone/30 border border-med-teal/10 rounded-lg outline-none focus:border-retro-orange text-sm">
